...
Optional later alternative, prepared September 5, 2026. The current fictional proof of concept is hosted on Vercel Hobby at **https://art-class-checkin-poc.vercel.app**, as requested by the owner. Netlify is deferred. This guide and the Node function adapter remain available for a future separately authorized Netlify project using the same Git repository. No Netlify account/project is connected, and no Netlify authorization is needed for the working Vercel demo.
