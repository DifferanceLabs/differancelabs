...
**Verified September 5, 2026:** Vercel CLI is authenticated as `jmzelnik`; team `differance-labs-projects` has active **Hobby** billing, with no Pro trial. Its base subscription is $0. The Supabase account plan, active cloud database, available quotas and existing paid database coverage remain unverified because Supabase access is not connected. No subscription was purchased.
